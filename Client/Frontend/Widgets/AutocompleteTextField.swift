...
class AutocompleteTextField: UITextField, UITextFieldDelegate {
    ...
    var normalizedEnteredText: String {
        return enteredText.lowercaseString.stringByTrimmingLeadingCharactersInSet(CharacterSet.whitespaceCharacterSet())
    }
    ...
    func setAutocompleteSuggestion(_ suggestion: String?) {
        ...
        if let suggestion = suggestion , isEditing && canAutocomplete && markedTextRange == nil {
            ...
            if suggestion.startsWith(normalizedEnteredText) && normalizedEnteredText.characters.count < suggestion.characters.count {
                let endingString = suggestion.substring(from: suggestion.characters.index(suggestion.startIndex, offsetBy: normalizedEnteredText.characters.count))
