...
class BrowserViewController: UIViewController {
    ...
    fileprivate func showCrashOptInAlert() {
    ...
    func addBookmark(_ url: String, title: String?, folderId:String? = nil, folderTitle:String? = nil, completion: @escaping ()->()? = nil) {
...
//                toApplication: UIApplication.sharedApplication())
    ...
    func removeBookmark(_ url: String, completion: @escaping ()->()? = nil) {
        profile.bookmarks.modelFactory >>== {
            $0.removeByURL(url).uponQueue(DispatchQueue.main) { res in
                if res.isSuccess {
...
//        }
    ...
    func updateURLBarDisplayURL(_ tab: Browser) {
        ...
        succeed().upon { _ in
            self.profile.bookmarks.modelFactory >>== {
                $0.isBookmarked(url).uponQueue(DispatchQueue.main) { result in
    ...
    func presentActivityViewController(_ url: URL, tab: Browser? = nil, sourceView: UIView?, sourceRect: CGRect, arrowDirection: UIPopoverArrowDirection) {
...
extension BrowserViewController {
    ...
    func recordNavigationInTab(_ tab: Browser, navigation: WKNavigation, visitType: VisitType) {
     ...
     */
    func getVisitTypeForTab(_ tab: Browser, navigation: WKNavigation?) -> VisitType? {
