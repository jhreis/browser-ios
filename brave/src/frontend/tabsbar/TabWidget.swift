...
class TabWidget : UIView {
    ...
    init(browser: Browser, parentScrollView: UIScrollView) {
        ...
        close.tintColor = UIColor.lightGray
    ...
    func deselect() {
        ...
        title.titleLabel!.font = UIFont.systemFont(ofSize: 11)
        title.setTitleColor(UIColor.init(white: 230/255, alpha: 1.0), for: UIControlState())
        close.isHidden = true
    }
    ...
    func setStyleToSelected() {
        title.titleLabel!.font = UIFont.systemFont(ofSize: 11, weight: UIFontWeightSemibold)
        title.setTitleColor(UIColor.init(white: 255/255, alpha: 1.0), for: UIControlState())
